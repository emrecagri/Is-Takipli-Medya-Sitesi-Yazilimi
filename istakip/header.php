	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				...
				if (yetkikontrol()=="yetkili") {?>
					<li class="nav-item">
						<a class="nav-link" href="siparisekle.php">
				...
				<li class="nav-item">
					<a class="nav-link" href="ziyaretciler.php">
				...
				if (yetkikontrol()=="yetkili") {?>
					<li class="nav-item">
						<a class="nav-link" href="veritabaniniyedekle.php">
							<i class="fas fas fa-fw fa-download"></i>
							<span>Veritabanını Yedekle</span>
						</a>
					</li>
				<?php } ?>
